...
public class IPv4Analyzer extends PSPacketAnalyzer
{
	...
	public Object[] getValues(){
        ...
        public void noti(Packet packet)
        {
            
            if("1".equals(values.get("Protocol")))
            {
        ...
        else if("17".equals(values.get("Protocol").toString()))
            {
            ...
            else if(values.get("Source IP")==values.get("Destination IP"))
                {   
                    JFrame frame=new JFrame();
                    JPanel p=new JPanel();
